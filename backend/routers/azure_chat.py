...
async def azure_chat(
    ...
    """
    try:
        # The AzureOpenAI client automatically reads the required environment variables.
        # It's smart enough to handle AZURE_OPENAI_ENDPOINT, AZURE_OPENAI_API_KEY, etc.
        client = AzureOpenAI(
    ...
    # Note: I've updated this to use AZURE_CHAT_DEPLOYMENT for clarity.
    ...
    try:
        ...
        # Check for missing deployment error, which gives a 404
