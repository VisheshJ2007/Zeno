...
# simple logger for request-level debugging
logger = logging.getLogger("zeno")
logging.basicConfig(level=logging.INFO)

# --- CORS: allow local dev (Live Server / localhost) ---
# Build CORS allow list from common dev hosts plus optional FRONTEND_ORIGIN env
_allow_origins = [
    "http://127.0.0.1:5500",
    "http://localhost:5500",
    "http://localhost:3000",
...
async def debug_echo():
    """Fast endpoint to verify server responsiveness (no DB access)."""
